-- models/mart_analytics/hex_ready/lead_enrollment_by_year.sql
-- LEAD Program Enrollment by Year with Demographics (5-Year Historical)
-- Course code 1205 (001205 in Aeries)

{{ config(
    materialized='table',
    schema='analytics',
    tags=['analytics', 'hex', 'enrollment', 'lead']
) }}
